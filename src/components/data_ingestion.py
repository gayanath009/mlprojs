...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            csv_path = os.path.join(current_dir, '..', 'notebook', 'data', 'student.csv') # Construct relative path from script location
...
#         try:
#             df = pd.read_csv('notebook\data\student.csv') # Read the CSV file into a DataFrame
#             logging.info("Read the dataset as dataframe") 
...
#             train_set.to_csv(self.ingestion_config.train_data_path, index=False) # Save the training set to a CSV file
#             test_set.to_csv(self.ingestion_config.test_data_path, index=False) # Save the testing set to a CSV file
